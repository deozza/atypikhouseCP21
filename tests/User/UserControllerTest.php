  ...
  */
  ...
  public function addDataProvider()
  {
    ...
    [
      ...
      ["kind" => "unit", "test" => ['method'=> 'PATCH'   , 'url' => 'api/user/00400000-0000-5000-a000-000000000000' ,'token' => 'token_userAdmin', 'status' => 400, 'in' => 'patchExistingEmailAdmin'   , 'out' => 'patchedExistingEmailAdmin'   ] ],
      ["kind" => "unit", "test" => ['method'=> 'PATCH'   , 'url' => 'api/user/00400000-0000-5000-a000-000000000000' ,'token' => 'token_userAdmin', 'status' => 400, 'in' => 'patchMissingDotEmailAdmin' , 'out' => 'patchedMissingDotEmailAdmin' ] ],
      ["kind" => "unit", "test" => ['method'=> 'PATCH'   , 'url' => 'api/user/00400000-0000-5000-a000-000000000000' ,'token' => 'token_userAdmin', 'status' => 400, 'in' => 'patchMissingAtEmailAdmin'  , 'out' => 'patchedMissingAtEmailAdmin'  ] ],
      ["kind" => "unit", "test" => ['method'=> 'PATCH'   , 'url' => 'api/user/00400000-0000-5000-a000-000000000000' ,'token' => 'token_userAdmin', 'status' => 400, 'in' => 'patchExistingLoginAdmin'   , 'out' => 'patchedExistingLoginAdmin'   ] ],
      ["kind" => "unit", "test" => ['method'=> 'PATCH'   , 'url' => 'api/user/00400000-0000-5000-a000-000000000000' ,'token' => 'token_userAdmin', 'status' => 400, 'in' => 'patchExtraFieldAdmin'      , 'out' => 'patchedExtraFieldAdmin'      ] ],
